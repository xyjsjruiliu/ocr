...
def init_args():
    ...
    parser.add_argument('--data', default='./imgs/8e476594583b496cbe630023e464fcde.jpg', type=str, help='img path or folder for predict')
...
if __name__ == '__main__':
    ...
    from ocr.utils.util import show_img, draw_bbox, save_result, get_file_list
